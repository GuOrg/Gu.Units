...
namespace GeneratorBox
{
    ...
    public partial struct Length : IComparable<Length>, IEquatable<Length>, IFormattable, IXmlSerializable, IUnitValue
    {
        ...
        /// </summary>
        /// <param name="s">The string representation of the <see cref="T:GeneratorBox.Length"/></param>
        /// <returns></returns>
        ...
        /// <returns>An instance of  <see cref="T:GeneratorBox.Length"/></returns>
        ...
        /// </returns>
        /// <param name="left">A <see cref="T:GeneratorBox.Length"/>.</param>
        /// <param name="right">A <see cref="T:GeneratorBox.Length"/>.</param>
        ...
        /// </returns>
        /// <param name="left">An <see cref="T:GeneratorBox.Length"/>.</param>
        /// <param name="right">An <see cref="T:GeneratorBox.Length"/>.</param>
        public static bool operator <(Length left, Length right)
        {
        ...
        /// </summary>
        /// <param name="right">An instance of <see cref="T:GeneratorBox.Length"/></param>
        /// <param name="left">An instance of <seealso cref="T:System.Double"/></param>
        /// <returns>Multiplies an instance of <see cref="T:GeneratorBox.Length"/> with <paramref name="left"/> and returns the result.</returns>
        ...
        /// </summary>
        /// <param name="left">An instance of <see cref="T:GeneratorBox.Length"/></param>
        /// <param name="right">An instance of <seealso cref="T:System.Double"/></param>
        /// <returns>Multiplies an instance of <see cref="T:GeneratorBox.Length"/> with <paramref name="right"/> and returns the result.</returns>
        ...
        /// <param name="left">An instance of <see cref="T:GeneratorBox.Length"/></param>
        /// <param name="right">An instance of <seealso cref="T:System.Double"/></param>
        /// <returns>Divides an instance of <see cref="T:GeneratorBox.Length"/> with <paramref name="right"/> and returns the result.</returns>
        public static Length operator /(Length left, double right)
        {
            return new Length(left.Meters / right);
        }
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="T:GeneratorBox.Length"/> whose value is the sum of the values of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">A <see cref="T:GeneratorBox.Length"/>.</param>
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="T:GeneratorBox.Length"/> that is the difference
        /// </returns>
        /// <param name="left">A <see cref="T:GeneratorBox.Length"/> (the minuend).</param>
        /// <param name="right">A <see cref="T:GeneratorBox.Length"/> (the subtrahend).</param>
        public static Length operator -(Length left, Length right)
        {
            return new Length(left.Meters - right.Meters);
        }
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="T:GeneratorBox.Length"/> with the same numeric value as this instance, but the opposite sign.
        /// </returns>
        /// <param name="Length">A <see cref="T:GeneratorBox.Length"/></param>
        ...
        /// </returns>
        /// <param name="other">An <see cref="T:GeneratorBox.Length"/> object to compare with this instance.</param>
