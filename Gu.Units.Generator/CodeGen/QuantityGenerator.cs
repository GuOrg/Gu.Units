    ...
    public static class QuantityGenerator
    {
        public static string Code(Quantity quantity)
        {
            return new StringBuilder()
                ...
                .AppendLine($"            var attribute = reader.GetAttribute(\"Value\");")
                .AppendLine($"            if (attribute is null)")
                .AppendLine($"            {{")
                .AppendLine($"                throw new XmlException($\"Could not find attribute named: Value\");")
                .AppendLine($"            }}")
                .AppendLine()
                .AppendLine($"            this  = new {quantity.Name}(XmlConvert.ToDouble(attribute), {quantity.Unit.ClassName}.{quantity.Unit.Name});")
                ...
                .AppendLine($"        {{")
                .AppendLine($"            writer.WriteStartAttribute(\"Value\");")
                .AppendLine($"            writer.WriteValue(this.{quantity.Unit.ParameterName});")
                .AppendLine($"            writer.WriteEndAttribute();")
                .AppendLine($"        }}")
                .AppendLine()
