...
.AppendLine($"    public partial struct {quantity.Name} : IQuantity<{quantity.UnitName}>, IComparable<{quantity.Name}>, IEquatable<{quantity.Name}>")
.AppendLine($"    {{")
.AppendLine($"        /// <summary>")
...
.AppendLine($"        /// </summary>")
.AppendLine($"        /// <returns>")
.AppendLine($"        /// An <see cref=\"Gu.Units.{quantity.Name}\"/> whose quantity is the sum of the quantitys of <paramref name=\"left\"/> and <paramref name=\"right\"/>.")
.AppendLine($"        /// </returns>")
.AppendLine($"        /// <param name=\"left\">The left instance of <see cref=\"Gu.Units.{quantity.Name}\"/>.</param>")
.AppendLine($"        /// <param name=\"right\">The right instance of <see cref=\"Gu.Units.{quantity.Name}\"/>.</param>")
...
.AppendLine($"        /// <param name=\"formatProvider\">Specifies the <see cref=\"IFormatProvider\"/> to use when creting the string representation.</param>")
.AppendLine($"        /// <returns>The string representation of the <see cref=\"{quantity.Name}\"/></returns>")
...
.AppendLine($"        /// </summary>")
.AppendLine($"        /// <param name=\"unit\">The unit to use in the conversion</param>")
.AppendLine($"        /// <param name=\"symbolFormat\">Specifies the symbol format to use when creting the string representation.</param>")
.AppendLine($"        /// <returns>The string representation of the value of this instance.</returns>")
...
.AppendLine($"        /// </summary>")
.AppendLine($"        /// <returns>")
.AppendLine($"        /// A signed number indicating the relative quantitys of this instance and <paramref name=\"quantity\"/>.")
.AppendLine($"        /// Value")
...
.AppendLine($"            }}")
.AppendLine()
.AppendLine($"            return obj is {quantity.Name} && this.Equals(({quantity.Name})obj);")
.AppendLine($"        }}")
.AppendLine()
.AppendLine($"        /// <summary>")
...
.AppendLine($"        /// </returns>")
.AppendLine($"        public XmlSchema GetSchema()")
.AppendLine($"        {{")
