    ...
    public static class Enumerable
    {
        public static string Code(Settings settings)
        {
            return new StringBuilder()
                ...
                .AppendLine("    {")
                .Sum(settings.Quantities)
                .SumNullable(settings.Quantities)
                .Min(settings.Quantities)
                .MinNullable(settings.Quantities)
                .Max(settings.Quantities)
                .MaxNullable(settings.Quantities)
                .Average(settings.Quantities)
                .AverageNullable(settings.Quantities)
                .AppendLine("    }")
                .AppendLine("}")
                .ToString();
        }
