    ...
    public static class UnitGenerator
    {
        public static string Code(Unit unit)
        {
            return new StringBuilder()
                ...
                .AppendLine($"        /// </summary>")
                .AppendLine($"        /// <param name=\"quantity\">The quantity.</param>")
                ...
                .AppendLine($"        /// </summary>")
                .AppendLine($"        /// <param name=\"format\">The format to use when converting</param>")
                ...
                .AppendLine($"        {{")
                .AppendLine($"            return obj is {unit.ClassName} other && this.Equals(other);")
                .AppendLine($"        }}")
                .AppendLine()
                .AppendLine($"        /// <inheritdoc />")
                .AppendLine($"        public override int GetHashCode()")
                .AppendLine($"        {{")
                .AppendLine($"            if (this.symbol is null)")
                .AppendLine($"            {{")
                .AppendLine($"                return 0; // Needed due to default constructor")
                .AppendLine($"            }}")
                .AppendLine()
