    ...
    public static class ValueConverterGenerator
    {
        public static string Code(Quantity quantity)
        {
            return new StringBuilder()
                ...
                .AppendLine($"                }}")
                .AppendLine()
                .AppendLine($"                this.unit = value.Value;")
                .AppendLine($"            }}")
                .AppendLine($"        }}")
                .AppendLine()
                .AppendLine($"        /// <summary>")
                ...
                .AppendLine($"            get")
                .AppendLine($"            {{")
                .AppendLine($"                return this.valueFormat;")
                .AppendLine($"            }}")
                .AppendLine()
                .AppendLine($"            set")
                .AppendLine($"            {{")
                ...
                .AppendLine($"            get")
                .AppendLine($"            {{")
                .AppendLine($"                return this.quantityFormat?.CompositeFormat;")
                .AppendLine($"            }}")
                .AppendLine()
                .AppendLine($"            set")
                .AppendLine($"            {{")
                ...
                .AppendLine($"                {{")
                .AppendLine($"                    if (this.unit != null && this.unit != this.quantityFormat.Unit)")
                .AppendLine($"                    {{")
                ...
                .AppendLine($"                if (this.binding == null && targetObject != null)")
                .AppendLine($"                {{")
                ...
                .AppendLine($"            }}")
                .AppendLine()
                .AppendLine($"            if (value != null && !(value is {quantity.Name}))")
                .AppendLine($"            {{")
                ...
                .AppendLine($"            if (this.bindingQuantityFormat != null)")
                .AppendLine($"            {{")
                ...
                .AppendLine($"                }}")
                .AppendLine()
                .AppendLine($"                if (this.ValueFormat != null)")
                .AppendLine($"                {{")
                ...
                .AppendLine($"                }}")
                .AppendLine()
                .AppendLine($"                if (this.StringFormat != null)")
                .AppendLine($"                {{")
                .AppendLine($"                    this.errorText.AppendLine($\"ValueFormat cannot be set when Binding.StringFormat is a unit format.\");")
                .AppendLine($"                }}")
                .AppendLine($"            }}")
                .AppendLine()
                .AppendLine($"            if (this.quantityFormat != null)")
                .AppendLine($"            {{")
                .AppendLine($"                if (this.ValueFormat != null)")
                .AppendLine($"                {{")
                ...
                .AppendLine($"            else")
                .AppendLine($"            {{")
                .AppendLine($"                if (this.unit != null && this.SymbolFormat != null)")
                .AppendLine($"                {{")
                ...
                .AppendLine($"                    this.unit != this.quantityFormat.Unit)")
                .AppendLine($"                {{")
                .AppendLine($"                    this.errorText.AppendLine($\"Unit is set to '{{this.unit}}' but StringFormat is '{{this.StringFormat.Replace(\"{{0:\", string.Empty).Replace(\"}}\", string.Empty)}}'\");")
                .AppendLine($"                }}")
                .AppendLine()
                .AppendLine($"                var hasBindingUnit = !string.IsNullOrEmpty(this.bindingQuantityFormat?.SymbolFormat);")
                .AppendLine($"            }}")
                ...
                .AppendLine($"                        }}")
                .AppendLine($"                        else if (this.SymbolFormat != null)")
                .AppendLine($"                        {{")
                .AppendLine($"                            this.quantityFormat = FormatCache<{quantity.UnitName}>.GetOrCreate(this.ValueFormat, this.unit.Value, this.SymbolFormat.Value);")
                .AppendLine($"                            if (this.UnitInput == null)")
                .AppendLine($"                            {{")
