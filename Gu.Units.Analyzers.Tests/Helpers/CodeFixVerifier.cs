namespace Gu.Units.Analyzers.Tests
{
    ...
    public abstract partial class CodeFixVerifier : DiagnosticVerifier
    {
        ...
        {
            this.VerifyFix(LanguageNames.VisualBasic, this.GetBasicCodeFixProvider(), oldSource, newSource, codeFixIndex, allowNewCompilerDiagnostics);
        }
        ...
        private void VerifyFix(string language, CodeFixProvider codeFixProvider, string oldSource, string newSource, int? codeFixIndex, bool allowNewCompilerDiagnostics)
        {
            ...
            for (int i = 0; i < attempts; ++i)
            {
                ...
                var context = new CodeFixContext(document, compilerDiagnostics[0], (a, d) => actions.Add(a), CancellationToken.None);
