...
namespace Gu.Units.Wpf
{
    ...
    /// <summary>
    /// An <see cref="IValueConverter"/> for quantities of type <see cref="AngularAcceleration"/>
    /// </summary>
    ...
    public class AngularAccelerationConverter : MarkupExtension, IValueConverter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gu.Units.Wpf.AngularAccelerationConverter"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="AngularAccelerationUnit"/>
        /// </summary>
        ...
        public object? Convert(object value, Type targetType, object? parameter, CultureInfo culture)
        {
            ...
            if (value is { } && !(value is AngularAcceleration))
            {
                message += $"{this.GetType().Name} only supports converting from {typeof(AngularAcceleration)}";
            }
