...
namespace Gu.Units.Wpf
{
    ...
    public class AmountOfSubstanceConverter : MarkupExtension, IValueConverter
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="Gu.Units.Wpf.AmountOfSubstanceConverter"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets and sets the <see cref="AmountOfSubstanceUnit"/>
        /// </summary>
            ...
            CultureInfo culture)
        {
            ...
            {
                message += $"{GetType().Name} only supports converting from {typeof(AmountOfSubstance)}";
            }
        ...
        private void Initialize()
        {
            ...
            else
            {
                ...
                {
                    this.quantityFormat = FormatCache<AmountOfSubstanceUnit>.GetOrCreate(ValueFormat, this.unit.Value, SymbolFormat.Value);
                }
            }
