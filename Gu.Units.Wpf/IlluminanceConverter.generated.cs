...
namespace Gu.Units.Wpf
{
    ...
    public class IlluminanceConverter : MarkupExtension, IValueConverter
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="Gu.Units.Wpf.IlluminanceConverter"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets and sets the <see cref="IlluminanceUnit"/>
        /// </summary>
            ...
            CultureInfo culture)
        {
            ...
            {
                message += $"{GetType().Name} only supports converting from {typeof(Illuminance)}";
            }
        ...
        private void Initialize()
        {
            ...
            else
            {
                ...
                {
                    this.quantityFormat = FormatCache<IlluminanceUnit>.GetOrCreate(ValueFormat, this.unit.Value, SymbolFormat.Value);
                }
            }
