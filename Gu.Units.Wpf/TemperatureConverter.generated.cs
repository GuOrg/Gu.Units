...
namespace Gu.Units.Wpf
{
    ...
    public class TemperatureConverter : MarkupExtension, IValueConverter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gu.Units.Wpf.TemperatureConverter"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="TemperatureUnit"/>
        /// </summary>
        ...
        public object? Convert(object value, Type targetType, object? parameter, CultureInfo culture)
        {
            ...
            if (value is { } && !(value is Temperature))
            {
                message += $"{this.GetType().Name} only supports converting from {typeof(Temperature)}";
            }
