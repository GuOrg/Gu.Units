namespace Gu.Units.Wpf
{
    ...
    public class MagneticFieldStrengthConverter : MarkupExtension, IValueConverter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gu.Units.Wpf.MagneticFieldStrengthConverter"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="MagneticFieldStrengthUnit"/>
        /// </summary>
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                message += $"{this.GetType().Name} only supports converting from {typeof(MagneticFieldStrength)}";
            }
