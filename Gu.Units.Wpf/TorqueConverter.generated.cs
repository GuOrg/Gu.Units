...
namespace Gu.Units.Wpf
{
    ...
    public class TorqueConverter : MarkupExtension, IValueConverter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gu.Units.Wpf.TorqueConverter"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="TorqueUnit"/>
        /// </summary>
        ...
        public object? Convert(object value, Type targetType, object? parameter, CultureInfo culture)
        {
            ...
            if (value is { } && !(value is Torque))
            {
                message += $"{this.GetType().Name} only supports converting from {typeof(Torque)}";
            }
