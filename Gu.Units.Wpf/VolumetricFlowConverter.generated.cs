...
[assembly: TypeForwardedTo(typeof(VolumetricFlow))]
[assembly: TypeForwardedTo(typeof(VolumetricFlowUnit))]
...
namespace Gu.Units.Wpf
{
    ...
    public class VolumetricFlowConverter : MarkupExtension, IValueConverter
    {
            ...
            CultureInfo culture)
        {
            ...
            if (value != null && !(value is VolumetricFlow) && Is.DesignMode)
            {
                var message = $"{GetType().Name} only supports converting from {typeof(VolumetricFlow)}";
                throw new ArgumentException(message, nameof(value));
            }
            ...
            if ((SymbolFormat != null || UnitInput == Wpf.UnitInput.SymbolRequired) &&
               (targetType == typeof(string) || targetType == typeof(object)))
            {
                return volumetricFlow.ToString(Unit.Value, SymbolFormat ?? Units.SymbolFormat.FractionSuperScript, culture);
            }
