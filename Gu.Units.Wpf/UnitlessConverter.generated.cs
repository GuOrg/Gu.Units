...
namespace Gu.Units.Wpf
{
    ...
    /// <summary>
    /// An <see cref="IValueConverter"/> for quantities of type <see cref="Unitless"/>
    /// </summary>
    ...
    public class UnitlessConverter : MarkupExtension, IValueConverter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gu.Units.Wpf.UnitlessConverter"/> class.
        /// </summary>
        ...
        public UnitlessConverter(UnitlessUnit unit)
        {
            this.Unit = unit;
        }

        /// <summary>
        /// Gets or sets the <see cref="UnitlessUnit"/>
        /// </summary>
        ...
        public object? Convert(object value, Type targetType, object? parameter, CultureInfo culture)
        {
            ...
            if (value is { } && !(value is Unitless))
            {
                message += $"{this.GetType().Name} only supports converting from {typeof(Unitless)}";
            }
