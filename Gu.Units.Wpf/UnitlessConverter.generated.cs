...
[assembly: TypeForwardedTo(typeof(Unitless))]
[assembly: TypeForwardedTo(typeof(UnitlessUnit))]
...
namespace Gu.Units.Wpf
{
    ...
    public class UnitlessConverter : MarkupExtension, IValueConverter
    {
        ...
        public UnitlessConverter([TypeConverter(typeof(UnitlessUnitTypeConverter))]UnitlessUnit unit)
        {
            Unit = unit;
        }

        [ConstructorArgument("unit"), TypeConverter(typeof(UnitlessUnitTypeConverter))]
