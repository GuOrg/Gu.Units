...
namespace Gu.Units.Wpf
{
    ...
    /// <summary>
    /// An <see cref="IValueConverter"/> for quantities of type <see cref="Flexibility"/>
    /// </summary>
    ...
    public class FlexibilityConverter : MarkupExtension, IValueConverter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gu.Units.Wpf.FlexibilityConverter"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="FlexibilityUnit"/>
        /// </summary>
        ...
        public object? Convert(object value, Type targetType, object? parameter, CultureInfo culture)
        {
            ...
            if (value is { } && !(value is Flexibility))
            {
                message += $"{this.GetType().Name} only supports converting from {typeof(Flexibility)}";
            }
