namespace Gu.Units.Wpf
{
    ...
    public class ForcePerUnitlessConverter : MarkupExtension, IValueConverter
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="Gu.Units.Wpf.ForcePerUnitlessConverter"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets and sets the <see cref="ForcePerUnitlessUnit"/>
        /// </summary>
            ...
            CultureInfo culture)
        {
            ...
            if (value != null && !(value is ForcePerUnitless))
            {
                message += $"{GetType().Name} only supports converting from {typeof(ForcePerUnitless)}";
            }
        ...
        private void Initialize()
        {
            ...
            else
            {
                ...
                {
                    this.quantityFormat = FormatCache<ForcePerUnitlessUnit>.GetOrCreate(ValueFormat, this.unit.Value, SymbolFormat.Value);
                }
            }
