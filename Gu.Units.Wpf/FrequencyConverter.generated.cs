...
namespace Gu.Units.Wpf
{
    ...
    public class FrequencyConverter : MarkupExtension, IValueConverter
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="Gu.Units.Wpf.FrequencyConverter"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets and sets the <see cref="FrequencyUnit"/>
        /// </summary>
            ...
            CultureInfo culture)
        {
            ...
            if (value != null && !(value is Frequency))
            {
                message += $"{GetType().Name} only supports converting from {typeof(Frequency)}";
            }
        ...
        private void Initialize()
        {
            ...
            else
            {
                ...
                {
                    this.quantityFormat = FormatCache<FrequencyUnit>.GetOrCreate(ValueFormat, this.unit.Value, SymbolFormat.Value);
                }
            }
