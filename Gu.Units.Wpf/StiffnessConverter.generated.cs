...
namespace Gu.Units.Wpf
{
    ...
    public class StiffnessConverter : MarkupExtension, IValueConverter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gu.Units.Wpf.StiffnessConverter"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="StiffnessUnit"/>
        /// </summary>
        ...
        public object? Convert(object value, Type targetType, object? parameter, CultureInfo culture)
        {
            ...
            if (value is { } && !(value is Stiffness))
            {
                message += $"{this.GetType().Name} only supports converting from {typeof(Stiffness)}";
            }
