namespace Gu.Units.Wpf
{
    ...
    /// <summary>
    /// An <see cref="IValueConverter"/> for quantities of type <see cref="ElectricalConductance"/>
    /// </summary>
    [MarkupExtensionReturnType(typeof(IValueConverter))]
    public class ElectricalConductanceConverter : MarkupExtension, IValueConverter
    {
        private ElectricalConductanceUnit? unit;
        private Binding binding;
        private QuantityFormat<ElectricalConductanceUnit> quantityFormat;
        private QuantityFormat<ElectricalConductanceUnit> bindingQuantityFormat;
        private string valueFormat;
        private bool initialized;
        private StringBuilder errorText = new StringBuilder();

        /// <summary>
        /// Initializes a new instance of <see cref="Gu.Units.Wpf.ElectricalConductanceConverter"/>.
        /// </summary>
        public ElectricalConductanceConverter()
        {
        }
        ...
        public ElectricalConductanceConverter(ElectricalConductanceUnit unit)
        {
            Unit = unit;
        }

        /// <summary>
        /// Gets and sets the <see cref="ElectricalConductanceUnit"/>
        /// </summary>
        [ConstructorArgument("unit"), TypeConverter(typeof(ElectricalConductanceUnitTypeConverter))]
        ...
        public string ValueFormat
        {
            ...
            set
            {
                if (!StringFormatParser<ElectricalConductanceUnit>.CanParseValueFormat(value))
                {
                    if (Is.DesignMode)
                    {
                        StringFormatParser<ElectricalConductanceUnit>.VerifyValueFormat(value);
                    }

                    this.errorText.AppendLine(StringFormatParser<ElectricalConductanceUnit>.CreateFormatErrorString(value, typeof(double)));
                }
        ...
        public string StringFormat
        {
            ...
            set
            {
                if (StringFormatParser<ElectricalConductanceUnit>.TryParse(value, out this.quantityFormat))
                {
                ...
                else
                {
                    if (Is.DesignMode)
                    {
                        StringFormatParser<ElectricalConductanceUnit>.VerifyQuantityFormat(value);
                    }

                    this.errorText.AppendLine(StringFormatParser<ElectricalConductanceUnit>.CreateFormatErrorString(value, typeof(ElectricalConductanceUnit)));
                }
            }
        }
            ...
            CultureInfo culture)
        {
            ...
            if (value != null && !(value is ElectricalConductance))
            {
                message += $"{GetType().Name} only supports converting from {typeof(ElectricalConductance)}";
            }
            ...
            if (this.bindingQuantityFormat != null)
            {
                ...
                {
                    return electricalConductance.GetValue(this.unit.Value);
                }
            ...
            if (targetType == typeof(string) || targetType == typeof(object))
            {
                ...
                {
                    return electricalConductance.ToString(this.quantityFormat, culture);
                }

                if (this.ValueFormat != null)
                {
                    return electricalConductance.GetValue(this.unit.Value).ToString(this.valueFormat, culture);
                }
            ...
            CultureInfo culture)
        {
            ...
            var message = this.errorText.ToString();
            if (!(targetType == typeof(ElectricalConductance) || targetType == typeof(ElectricalConductance?)))
            {
                message += $"{GetType().Name} does not support converting to {targetType.Name}";
            }
            ...
            if (value is double)
            {
                return new ElectricalConductance((double)value, this.unit.Value);
            }
                ...
                case Wpf.UnitInput.ScalarOnly:
                    {
                        ...
                        {
                            return new ElectricalConductance(d, this.unit.Value);
                        }
                        ElectricalConductance result;
                        if (ElectricalConductance.TryParse(text, NumberStyles.Float, culture, out result))
                        {
        ...
        private void Initialize()
        {
            ...
            else
            {
                ...
                {
                    this.quantityFormat = FormatCache<ElectricalConductanceUnit>.GetOrCreate(ValueFormat, this.unit.Value, SymbolFormat.Value);
                }
            }
            ...
            if (this.UnitInput == Wpf.UnitInput.SymbolRequired)
            {
                if (string.IsNullOrEmpty(this.quantityFormat?.SymbolFormat))
                {
                    if (string.IsNullOrEmpty(this.bindingQuantityFormat?.SymbolFormat))
                    {
                        ...
                        {
                            this.quantityFormat = FormatCache<ElectricalConductanceUnit>.GetOrCreate(this.ValueFormat, this.unit.Value, this.SymbolFormat.Value);
                        ...
                        {
                            this.quantityFormat = FormatCache<ElectricalConductanceUnit>.GetOrCreate(this.ValueFormat, this.unit.Value);
                            if (this.UnitInput == null)
                            {
