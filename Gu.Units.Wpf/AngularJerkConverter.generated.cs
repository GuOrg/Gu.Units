namespace Gu.Units.Wpf
{
    ...
    public class AngularJerkConverter : MarkupExtension, IValueConverter
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="Gu.Units.Wpf.AngularJerkConverter"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets and sets the <see cref="AngularJerkUnit"/>
        /// </summary>
            ...
            CultureInfo culture)
        {
            ...
            {
                message += $"{GetType().Name} only supports converting from {typeof(AngularJerk)}";
            }
        ...
        private void Initialize()
        {
            ...
            else
            {
                ...
                {
                    this.quantityFormat = FormatCache<AngularJerkUnit>.GetOrCreate(ValueFormat, this.unit.Value, SymbolFormat.Value);
                }
            }
