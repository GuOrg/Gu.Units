...
namespace Gu.Units.Wpf
{
    ...
    /// <summary>
    /// An <see cref="IValueConverter"/> for quantities of type <see cref="Energy"/>
    /// </summary>
    ...
    public class EnergyConverter : MarkupExtension, IValueConverter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gu.Units.Wpf.EnergyConverter"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="EnergyUnit"/>
        /// </summary>
        ...
        public object? Convert(object value, Type targetType, object? parameter, CultureInfo culture)
        {
            ...
            if (value is { } && !(value is Energy))
            {
                message += $"{this.GetType().Name} only supports converting from {typeof(Energy)}";
            }
