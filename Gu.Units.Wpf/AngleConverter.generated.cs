...
namespace Gu.Units.Wpf
{
    ...
    /// <summary>
    /// An <see cref="IValueConverter"/> for quantities of type <see cref="Angle"/>
    /// </summary>
    ...
    public class AngleConverter : MarkupExtension, IValueConverter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gu.Units.Wpf.AngleConverter"/> class.
        /// </summary>
        ...
        public AngleConverter(AngleUnit unit)
        {
            this.Unit = unit;
        }

        /// <summary>
        /// Gets or sets the <see cref="AngleUnit"/>
        /// </summary>
        ...
        public object? Convert(object value, Type targetType, object? parameter, CultureInfo culture)
        {
            ...
            if (value is { } && !(value is Angle))
            {
                message += $"{this.GetType().Name} only supports converting from {typeof(Angle)}";
            }
            ...
            if (targetType == typeof(string) || targetType == typeof(object))
            {
                ...
                {
                    return angle.GetValue(this.unit!.Value).ToString(this.valueFormat, culture);
                }
