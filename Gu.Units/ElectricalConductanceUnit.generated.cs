namespace Gu.Units
{
    ...
    public struct ElectricalConductanceUnit : IUnit, IUnit<ElectricalConductance>, IEquatable<ElectricalConductanceUnit>
    {
        ...
        /// <summary>
        /// Gets the symbol for the <see cref="Gu.Units.ElectricalConductanceUnit"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ElectricalConductanceUnit"/> struct.
        /// </summary>
        /// <param name="toSiemens">The conversion to <see cref="Siemens"/></param>
        /// <param name="fromSiemens">The conversion to <paramref name="symbol"/></param>
        /// <param name="symbol">The symbol for the <see cref="Siemens"/></param>
        ...
        /// <summary>
        /// Gets the default unit for <see cref="Gu.Units.ElectricalConductanceUnit"/>
        /// </summary>
        ...
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.ElectricalConductanceUnit"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.ElectricalConductanceUnit"/>.</param>
        ...
        {
            return this.FromSiUnit(quantity.siemens);
        }
        ...
        {
            var paddedFormat = UnitFormatCache<ElectricalConductanceUnit>.GetOrCreate(this, symbolFormat);
            using (var builder = StringBuilderPool.Borrow())
            {
                builder.Append(paddedFormat.PrePadding);
                builder.Append(paddedFormat.Format);
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is ElectricalConductanceUnit && this.Equals((ElectricalConductanceUnit)obj);
        }
