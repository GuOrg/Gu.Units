namespace Gu.Units
{
    ...
    public class VolumetricFlowTypeConverter : TypeConverter
    {
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            if (destinationType == typeof(InstanceDescriptor) && value is VolumetricFlow)
            {
                MethodInfo method = typeof(VolumetricFlow).GetMethod(nameof(VolumetricFlow.Parse), new Type[] { typeof(string) });
                if (method != null)
                {
