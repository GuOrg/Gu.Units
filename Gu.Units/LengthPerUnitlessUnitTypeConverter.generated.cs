namespace Gu.Units
{
    ...
    /// </devdoc>
    public class LengthPerUnitlessUnitTypeConverter : TypeConverter
    {
        /// <devdoc>
        ///    <para>Gets a value indicating whether this converter can
        ///       convert an object in the given source type to a <see cref='Gu.Units.LengthPerUnitlessUnit'/> object using the
        ...
        /// <devdoc>
        /// <para>Converts the given object to a <see cref='Gu.Units.LengthPerUnitlessUnit'/>
        /// object.</para>
        /// </devdoc>
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            {
                text = text.Trim();
                return LengthPerUnitlessUnit.Parse(text);
            }
