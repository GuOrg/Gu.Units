...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct Volume : IQuantity<VolumeUnit>, IComparable<Volume>, IEquatable<Volume>, IXmlSerializable
    {
        /// <summary>
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new Volume(XmlConvert.ToDouble(attribute), VolumeUnit.CubicMetres);
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(this.cubicMetres);
