namespace Gu.Units
{
    ...
    public partial struct LuminousFlux : IQuantity<LuminousFluxUnit>, IComparable<LuminousFlux>, IEquatable<LuminousFlux>
    {
        ...
        /// </summary>
        /// <param name="s">The string representation of the <see cref="Gu.Units.LuminousFlux"/></param>
        /// <returns></returns>
		public static LuminousFlux Parse(string s)
        {
            return QuantityParser.Parse<LuminousFluxUnit, LuminousFlux>(s, From, NumberStyles.Float, CultureInfo.CurrentCulture);
        }

        public static LuminousFlux Parse(string s, IFormatProvider provider)
        {
            return QuantityParser.Parse<LuminousFluxUnit, LuminousFlux>(s, From, NumberStyles.Float, provider);
        }

        public static LuminousFlux Parse(string s, NumberStyles styles)
        {
            return QuantityParser.Parse<LuminousFluxUnit, LuminousFlux>(s, From, styles, CultureInfo.CurrentCulture);
        }

        public static LuminousFlux Parse(string s, NumberStyles styles, IFormatProvider provider)
        {
            return QuantityParser.Parse<LuminousFluxUnit, LuminousFlux>(s, From, styles, provider);
        }

        public static bool TryParse(string s, out LuminousFlux value)
        {
            return QuantityParser.TryParse<LuminousFluxUnit, LuminousFlux>(s, From, NumberStyles.Float, CultureInfo.CurrentCulture, out value);
        }

        public static bool TryParse(string s, IFormatProvider provider, out LuminousFlux value)
        {
            return QuantityParser.TryParse<LuminousFluxUnit, LuminousFlux>(s, From, NumberStyles.Float, provider, out value);
        }

        public static bool TryParse(string s, NumberStyles styles, out LuminousFlux value)
        {
            return QuantityParser.TryParse<LuminousFluxUnit, LuminousFlux>(s, From, styles, CultureInfo.CurrentCulture, out value);
        }

        public static bool TryParse(string s, NumberStyles styles, IFormatProvider provider, out LuminousFlux value)
        {
            return QuantityParser.TryParse<LuminousFluxUnit, LuminousFlux>(s, From, styles, provider, out value);
        }
