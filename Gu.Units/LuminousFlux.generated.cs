...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct LuminousFlux : IQuantity<LuminousFluxUnit>, IComparable<LuminousFlux>, IEquatable<LuminousFlux>, IXmlSerializable
    {
        /// <summary>
        /// Gets a value that is zero <see cref="Gu.Units.LuminousFluxUnit.Lumens"/>
        /// </summary>
        public static readonly LuminousFlux Zero = default(LuminousFlux);
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gu.Units.LuminousFlux"/> struct.
        /// </summary>
        ...
        /// <summary>
        /// Gets the quantity in <see cref="Gu.Units.LuminousFluxUnit.Lumens"/>
        /// </summary>
        public double SiValue => this.lumens;

        /// <summary>
        /// Gets the <see cref="Gu.Units.LuminousFluxUnit"/> for the <see cref="SiValue"/>
        /// </summary>
        ...
        /// <returns>The <see cref="SolidAngle"/> that is the result from the division.</returns>
        ...
        /// <param name="left">The left value</param>
        /// <param name="right">The right value</param>
        /// <returns>The <see cref="LuminousIntensity"/> that is the result from the division.</returns>
        ...
        /// <param name="left">The left value</param>
        /// <param name="right">The right value</param>
        /// <returns>The <see cref="Illuminance"/> that is the result from the division.</returns>
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.LuminousFlux"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.LuminousFlux"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.LuminousFlux"/>.</param>
        ...
        /// <returns>The <see cref="Gu.Units.LuminousFlux"/> parsed from <paramref name="text"/></returns>
        ...
        /// </summary>
        /// <param name="text">The string representation of the <see cref="Gu.Units.LuminousFlux"/></param>
        /// <param name="result">The parsed <see cref="LuminousFlux"/></param>
        /// <returns>True if an instance of <see cref="LuminousFlux"/> could be parsed from <paramref name="text"/></returns>
        ...
        {
            var quantityFormat = FormatCache<LuminousFluxUnit>.GetOrCreate(string.Empty, this.SiUnit);
        ...
        /// <returns>
        /// true if <paramref name="obj"/> represents the same <see cref="Gu.Units.LuminousFlux"/> as this instance; otherwise, false.
        /// </returns>
        public override bool Equals(object? obj)
        {
            return obj is LuminousFlux other && this.Equals(other);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new LuminousFlux(XmlConvert.ToDouble(attribute), LuminousFluxUnit.Lumens);
