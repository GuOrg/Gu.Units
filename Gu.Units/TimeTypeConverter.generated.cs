namespace Gu.Units
{
    ...
    public class TimeTypeConverter : TypeConverter
    {
        ...
        ///       convert an object in the given source type to a <see cref='Gu.Units.Time'/> object using the
        ...
        /// <devdoc>
        /// <para>Converts the given object to a <see cref='Gu.Units.Time'/>
        /// object.</para>
        /// </devdoc>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            if (destinationType == typeof(InstanceDescriptor) && value is Time)
            {
                MethodInfo method = typeof(Time).GetMethod(nameof(Time.Parse), new Type[] { typeof(string) });
                if (method != null)
                {
