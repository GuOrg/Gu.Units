...
namespace Gu.Units
{
    ...
    public partial struct Jerk : IQuantity<JerkUnit>, IComparable<Jerk>, IEquatable<Jerk>, IXmlSerializable
    {
        ...
        /// </summary>
        public static readonly Jerk Zero = default(Jerk);
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gu.Units.Jerk"/> struct.
        /// </summary>
        ...
        /// <summary>
        /// Gets the quantity in <see cref="Gu.Units.JerkUnit.MetresPerSecondCubed"/>
        /// </summary>
        public double SiValue => this.metresPerSecondCubed;

        /// <summary>
        /// Gets the <see cref="Gu.Units.JerkUnit"/> for the <see cref="SiValue"/>
        /// </summary>
        ...
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Jerk"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Jerk"/>.</param>
        ...
        /// <returns>Multiplies <paramref name="left"/> with <see cref="Gu.Units.Jerk"/> and returns the result.</returns>
        ...
        /// <returns>Multiplies an <see cref="Gu.Units.Jerk"/> with <paramref name="right"/> and returns the result.</returns>
        ...
        /// <param name="left">The left instance of <see cref="Gu.Units.Jerk"/></param>
        /// <param name="right">The right instance of <seealso cref="double"/></param>
        /// <returns>Divides an instance of <see cref="Gu.Units.Jerk"/> by <paramref name="right"/> and returns the result.</returns>
        public static Jerk operator /(Jerk left, double right)
        {
            return new Jerk(left.metresPerSecondCubed / right);
        }
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.Jerk"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Jerk"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Jerk"/>.</param>
        ...
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Jerk"/> (the minuend).</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Jerk"/> (the subtrahend).</param>
        public static Jerk operator -(Jerk left, Jerk right)
        {
            return new Jerk(left.metresPerSecondCubed - right.metresPerSecondCubed);
        }
        ...
        {
            var quantityFormat = FormatCache<JerkUnit>.GetOrCreate(string.Empty, this.SiUnit);
        ...
        {
            return obj is Jerk other && this.Equals(other);
        }
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(this.metresPerSecondCubed);
