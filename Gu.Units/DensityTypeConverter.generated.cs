namespace Gu.Units
{
    ...
    public class DensityTypeConverter : TypeConverter
    {
        ...
        ///       convert an object in the given source type to a <see cref='Gu.Units.Density'/> object using the
        ...
        /// <devdoc>
        /// <para>Converts the given object to a <see cref='Gu.Units.Density'/>
        /// object.</para>
        /// </devdoc>
