namespace Gu.Units
{
    ...
    public class AngleTypeConverter : TypeConverter
    {
        ...
        ///       convert an object in the given source type to a <see cref='Gu.Units.Angle'/> object using the
        ...
        /// <devdoc>
        /// <para>Converts the given object to a <see cref='Gu.Units.Angle'/>
        /// object.</para>
        /// </devdoc>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            if (destinationType == typeof(InstanceDescriptor) && value is Angle)
            {
                MethodInfo method = typeof(Angle).GetMethod(nameof(Angle.Parse), new Type[] { typeof(string) });
                if (method != null)
                {
