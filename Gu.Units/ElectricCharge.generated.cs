...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.ElectricCharge"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.ElectricCharge"/>.</param>
        ...
        /// <returns>Multiplies <paramref name="left"/> with <see cref="Gu.Units.ElectricCharge"/> and returns the result.</returns>
        ...
        /// <returns>Multiplies an <see cref="Gu.Units.ElectricCharge"/> with <paramref name="right"/> and returns the result.</returns>
        ...
        /// <param name="left">The left instance of <see cref="Gu.Units.ElectricCharge"/></param>
        /// <param name="right">The right instance of <seealso cref="double"/></param>
        /// <returns>Divides an instance of <see cref="Gu.Units.ElectricCharge"/> by <paramref name="right"/> and returns the result.</returns>
        public static ElectricCharge operator /(ElectricCharge left, double right)
        {
            return new ElectricCharge(left.coulombs / right);
        }
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.ElectricCharge"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.ElectricCharge"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.ElectricCharge"/>.</param>
        ...
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.ElectricCharge"/> (the minuend).</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.ElectricCharge"/> (the subtrahend).</param>
        public static ElectricCharge operator -(ElectricCharge left, ElectricCharge right)
        {
            return new ElectricCharge(left.coulombs - right.coulombs);
        }
        ...
        /// <summary>
        /// Compares this instance to a specified <see cref="Gu.Units.ElectricCharge"/> object and returns an integer that indicates whether this <paramref name="quantity"/> is smaller than, equal to, or greater than the <see cref="Gu.Units.ElectricCharge"/> object.
        /// </summary>
        /// <returns>
        ...
        /// <returns>
        /// true if <paramref name="obj"/> represents the same <see cref="Gu.Units.ElectricCharge"/> as this instance; otherwise, false.
        /// </returns>
        public override bool Equals(object? obj)
        {
            return obj is ElectricCharge other && this.Equals(other);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new ElectricCharge(XmlConvert.ToDouble(attribute), ElectricChargeUnit.Coulombs);
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(this.coulombs);
