namespace Gu.Units
{
    ...
    public partial struct Acceleration : IComparable<Acceleration>, IEquatable<Acceleration>, IFormattable, IXmlSerializable, IQuantity<LengthUnit, I1, TimeUnit, INeg2>
    {
        ...
        /// <summary>
        /// Compares this instance to a specified <see cref="T:MathNet.Spatial.Units.Acceleration"/> object and returns an integer that indicates whether this <see cref="instance"/> is shorter than, equal to, or longer than the <see cref="T:MathNet.Spatial.Units.Acceleration"/> object.
        /// </summary>
        /// <returns>
