...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct Current : IQuantity<CurrentUnit>, IComparable<Current>, IEquatable<Current>, IXmlSerializable
    {
        /// <summary>
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.Current"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Current"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Current"/>.</param>
        ...
        {
            return obj is Current other && this.Equals(other);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new Current(XmlConvert.ToDouble(attribute), CurrentUnit.Amperes);
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(this.amperes);
