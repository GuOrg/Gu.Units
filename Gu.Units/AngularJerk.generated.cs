...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        {
            return obj is AngularJerk other && this.Equals(other);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new AngularJerk(XmlConvert.ToDouble(attribute), AngularJerkUnit.RadiansPerSecondCubed);
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(this.radiansPerSecondCubed);
