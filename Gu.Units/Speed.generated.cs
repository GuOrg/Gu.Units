...
namespace Gu.Units
{
    ...
    public partial struct Speed : IQuantity<SpeedUnit>, IComparable<Speed>, IEquatable<Speed>
    {
        ...
        /// </summary>
        public static readonly Speed Zero = default(Speed);
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gu.Units.Speed"/> struct.
        /// </summary>
        ...
        /// <summary>
        /// Gets the quantity in <see cref="Gu.Units.SpeedUnit.MetresPerSecond"/>
        /// </summary>
        public double SiValue => this.metresPerSecond;

        /// <summary>
        /// Gets the <see cref="Gu.Units.SpeedUnit"/> for the <see cref="SiValue"/>
        /// </summary>
        ...
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Speed"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Speed"/>.</param>
        ...
        /// <returns>Multiplies <paramref name="left"/> with <see cref="Gu.Units.Speed"/> and returns the result.</returns>
        ...
        /// <returns>Multiplies an <see cref="Gu.Units.Speed"/> with <paramref name="right"/> and returns the result.</returns>
        ...
        /// <param name="left">The left instance of <see cref="Gu.Units.Speed"/></param>
        /// <param name="right">The right instance of <seealso cref="double"/></param>
        /// <returns>Divides an instance of <see cref="Gu.Units.Speed"/> by <paramref name="right"/> and returns the result.</returns>
        public static Speed operator /(Speed left, double right)
        {
            return new Speed(left.metresPerSecond / right);
        }
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.Speed"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Speed"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Speed"/>.</param>
        ...
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Speed"/> (the minuend).</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Speed"/> (the subtrahend).</param>
        public static Speed operator -(Speed left, Speed right)
        {
            return new Speed(left.metresPerSecond - right.metresPerSecond);
        }
        ...
        {
            var quantityFormat = FormatCache<SpeedUnit>.GetOrCreate(string.Empty, this.SiUnit);
        ...
        /// <summary>
        /// Compares this instance to a specified <see cref="Gu.Units.Speed"/> object and returns an integer that indicates whether this <paramref name="quantity"/> is smaller than, equal to, or greater than the <see cref="Gu.Units.Speed"/> object.
        /// </summary>
        /// <returns>
        ...
        /// <returns>
        /// true if <paramref name="obj"/> represents the same <see cref="Gu.Units.Speed"/> as this instance; otherwise, false.
        /// </returns>
        public override bool Equals(object? obj)
        {
            return obj is Speed other && this.Equals(other);
        }
