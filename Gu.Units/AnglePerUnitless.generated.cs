namespace Gu.Units
{
    ...
    public partial struct AnglePerUnitless : IQuantity<AnglePerUnitlessUnit>, IComparable<AnglePerUnitless>, IEquatable<AnglePerUnitless>
    {
        ...
        /// </summary>
        /// <param name="s">The string representation of the <see cref="Gu.Units.AnglePerUnitless"/></param>
        /// <returns></returns>
		public static AnglePerUnitless Parse(string s)
        {
            return QuantityParser.Parse<AnglePerUnitlessUnit, AnglePerUnitless>(s, From, NumberStyles.Float, CultureInfo.CurrentCulture);
        }

        public static AnglePerUnitless Parse(string s, IFormatProvider provider)
        {
            return QuantityParser.Parse<AnglePerUnitlessUnit, AnglePerUnitless>(s, From, NumberStyles.Float, provider);
        }

        public static AnglePerUnitless Parse(string s, NumberStyles styles)
        {
            return QuantityParser.Parse<AnglePerUnitlessUnit, AnglePerUnitless>(s, From, styles, CultureInfo.CurrentCulture);
        }

        public static AnglePerUnitless Parse(string s, NumberStyles styles, IFormatProvider provider)
        {
            return QuantityParser.Parse<AnglePerUnitlessUnit, AnglePerUnitless>(s, From, styles, provider);
        }

        public static bool TryParse(string s, out AnglePerUnitless value)
        {
            return QuantityParser.TryParse<AnglePerUnitlessUnit, AnglePerUnitless>(s, From, NumberStyles.Float, CultureInfo.CurrentCulture, out value);
        }

        public static bool TryParse(string s, IFormatProvider provider, out AnglePerUnitless value)
        {
            return QuantityParser.TryParse<AnglePerUnitlessUnit, AnglePerUnitless>(s, From, NumberStyles.Float, provider, out value);
        }

        public static bool TryParse(string s, NumberStyles styles, out AnglePerUnitless value)
        {
            return QuantityParser.TryParse<AnglePerUnitlessUnit, AnglePerUnitless>(s, From, styles, CultureInfo.CurrentCulture, out value);
        }

        public static bool TryParse(string s, NumberStyles styles, IFormatProvider provider, out AnglePerUnitless value)
        {
            return QuantityParser.TryParse<AnglePerUnitlessUnit, AnglePerUnitless>(s, From, styles, provider, out value);
        }
