...
namespace Gu.Units
{
    ...
    public partial struct Time : IComparable<Time>, IEquatable<Time>, IFormattable, IXmlSerializable, IUnitValue
    {
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="T:Gu.Units.Time"/> whose value is the sum of the values of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">A <see cref="T:Gu.Units.Time"/>.</param>
        ...
        /// <summary>
        /// Returns an <see cref="T:Gu.Units.Time"/> whose value is the negated value of the specified instance.
        /// </summary>
        /// <returns>
        /// An <see cref="T:Gu.Units.Time"/> with the same numeric value as this instance, but the opposite sign.
        /// </returns>
        ...
        /// <summary>
        /// Returns a value indicating whether this instance is equal to a specified <see cref="T:Gu.Units.Time"/> object.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Returns a value indicating whether this instance is equal to a specified <see cref="T:Gu.Units.Time"/> object within the given tolerance.
        /// </summary>
        /// <returns>
        /// true if <paramref name="other"/> represents the same Time as this instance; otherwise, false.
        /// </returns>
