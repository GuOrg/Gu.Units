namespace Gu.Units
{
    ...
    public class CapacitanceTypeConverter : TypeConverter
    {
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            if (destinationType == typeof(InstanceDescriptor) && value is Capacitance)
            {
                MethodInfo method = typeof(Capacitance).GetMethod(nameof(Capacitance.Parse), new Type[] { typeof(string) });
                if (method != null)
                {
