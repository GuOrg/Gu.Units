...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.SolidAngle"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.SolidAngle"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.SolidAngle"/>.</param>
        ...
        {
            return obj is SolidAngle other && this.Equals(other);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new SolidAngle(XmlConvert.ToDouble(attribute), SolidAngleUnit.Steradians);
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(this.steradians);
