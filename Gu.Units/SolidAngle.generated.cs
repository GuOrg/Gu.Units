namespace Gu.Units
{
    ...
    public partial struct SolidAngle : IQuantity<SolidAngleUnit>, IComparable<SolidAngle>, IEquatable<SolidAngle>
    {
        ...
        /// </summary>
        /// <param name="s">The string representation of the <see cref="Gu.Units.SolidAngle"/></param>
        /// <returns></returns>
		public static SolidAngle Parse(string s)
        {
            return QuantityParser.Parse<SolidAngleUnit, SolidAngle>(s, From, NumberStyles.Float, CultureInfo.CurrentCulture);
        }

        public static SolidAngle Parse(string s, IFormatProvider provider)
        {
            return QuantityParser.Parse<SolidAngleUnit, SolidAngle>(s, From, NumberStyles.Float, provider);
        }

        public static SolidAngle Parse(string s, NumberStyles styles)
        {
            return QuantityParser.Parse<SolidAngleUnit, SolidAngle>(s, From, styles, CultureInfo.CurrentCulture);
        }

        public static SolidAngle Parse(string s, NumberStyles styles, IFormatProvider provider)
        {
            return QuantityParser.Parse<SolidAngleUnit, SolidAngle>(s, From, styles, provider);
        }

        public static bool TryParse(string s, out SolidAngle value)
        {
            return QuantityParser.TryParse<SolidAngleUnit, SolidAngle>(s, From, NumberStyles.Float, CultureInfo.CurrentCulture, out value);
        }

        public static bool TryParse(string s, IFormatProvider provider, out SolidAngle value)
        {
            return QuantityParser.TryParse<SolidAngleUnit, SolidAngle>(s, From, NumberStyles.Float, provider, out value);
        }

        public static bool TryParse(string s, NumberStyles styles, out SolidAngle value)
        {
            return QuantityParser.TryParse<SolidAngleUnit, SolidAngle>(s, From, styles, CultureInfo.CurrentCulture, out value);
        }

        public static bool TryParse(string s, NumberStyles styles, IFormatProvider provider, out SolidAngle value)
        {
            return QuantityParser.TryParse<SolidAngleUnit, SolidAngle>(s, From, styles, provider, out value);
        }
