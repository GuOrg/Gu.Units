namespace Gu.Units
{
    ...
    public class AreaDensityUnitTypeConverter : TypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            if (text != null)
            {
                AreaDensityUnit result;
                if (AreaDensityUnit.TryParse(text, out result))
                {
                    return result;
                }

                var message = $"Could not convert the string '{text}' to an instance of AreaDensityUnit)";
        ...
        {
            if (value is AreaDensityUnit && destinationType != null)
            {
                var unit = (AreaDensityUnit)value;
                ...
                {
                    var parseMethod = typeof(AreaDensityUnit).GetMethod(nameof(AreaDensityUnit.Parse), new Type[] { typeof(string) });
                    if (parseMethod != null)
                    {
