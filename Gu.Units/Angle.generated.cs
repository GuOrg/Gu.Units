...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct Angle : IQuantity<AngleUnit>, IComparable<Angle>, IEquatable<Angle>, IXmlSerializable
    {
        /// <summary>
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.Angle"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Angle"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Angle"/>.</param>
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new Angle(XmlConvert.ToDouble(attribute), AngleUnit.Radians);
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(this.radians);
