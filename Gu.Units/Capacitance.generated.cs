...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.Capacitance"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Capacitance"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Capacitance"/>.</param>
        ...
        {
            return obj is Capacitance other && this.Equals(other);
        }
