...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct Conductivity : IQuantity<ConductivityUnit>, IComparable<Conductivity>, IEquatable<Conductivity>, IXmlSerializable
    {
        /// <summary>
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.Conductivity"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Conductivity"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Conductivity"/>.</param>
        ...
        {
            return obj is Conductivity other && this.Equals(other);
        }
