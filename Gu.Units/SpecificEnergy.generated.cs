namespace Gu.Units
{
    ...
    public partial struct SpecificEnergy : IComparable<SpecificEnergy>, IEquatable<SpecificEnergy>, IFormattable, IXmlSerializable, IQuantity<LengthUnit, I2, TimeUnit, INeg2>
    {
        ...
        /// <summary>
        /// Compares this instance to a specified <see cref="T:MathNet.Spatial.Units.SpecificEnergy"/> object and returns an integer that indicates whether this <see cref="instance"/> is shorter than, equal to, or longer than the <see cref="T:MathNet.Spatial.Units.SpecificEnergy"/> object.
        /// </summary>
        /// <returns>
