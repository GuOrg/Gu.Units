...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct SpecificEnergy : IQuantity<SpecificEnergyUnit>, IComparable<SpecificEnergy>, IEquatable<SpecificEnergy>, IXmlSerializable
    {
        /// <summary>
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.SpecificEnergy"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.SpecificEnergy"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.SpecificEnergy"/>.</param>
        ...
        {
            return obj is SpecificEnergy other && this.Equals(other);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new SpecificEnergy(XmlConvert.ToDouble(attribute), SpecificEnergyUnit.JoulesPerKilogram);
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(this.joulesPerKilogram);
