...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct AngularSpeed : IQuantity<AngularSpeedUnit>, IComparable<AngularSpeed>, IEquatable<AngularSpeed>, IXmlSerializable
    {
        /// <summary>
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.AngularSpeed"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.AngularSpeed"/>.</param>
        ...
        /// <returns>Multiplies <paramref name="left"/> with <see cref="Gu.Units.AngularSpeed"/> and returns the result.</returns>
        ...
        /// <returns>Multiplies an <see cref="Gu.Units.AngularSpeed"/> with <paramref name="right"/> and returns the result.</returns>
        ...
        /// <param name="left">The left instance of <see cref="Gu.Units.AngularSpeed"/></param>
        /// <param name="right">The right instance of <seealso cref="double"/></param>
        /// <returns>Divides an instance of <see cref="Gu.Units.AngularSpeed"/> by <paramref name="right"/> and returns the result.</returns>
        public static AngularSpeed operator /(AngularSpeed left, double right)
        {
            return new AngularSpeed(left.radiansPerSecond / right);
        }
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.AngularSpeed"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.AngularSpeed"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.AngularSpeed"/>.</param>
        ...
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.AngularSpeed"/> (the minuend).</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.AngularSpeed"/> (the subtrahend).</param>
        public static AngularSpeed operator -(AngularSpeed left, AngularSpeed right)
        {
            return new AngularSpeed(left.radiansPerSecond - right.radiansPerSecond);
        }
        ...
        /// <returns>The <see cref="Gu.Units.AngularSpeed"/> parsed from <paramref name="text"/></returns>
        ...
        /// <returns>The <see cref="Gu.Units.AngularSpeed"/> parsed from <paramref name="text"/></returns>
        public static AngularSpeed Parse(string text, IFormatProvider provider)
        {
            return QuantityParser.Parse<AngularSpeedUnit, AngularSpeed>(text, From, NumberStyles.Float, provider);
        }
        ...
        /// <returns>The <see cref="Gu.Units.AngularSpeed"/> parsed from <paramref name="text"/></returns>
        public static AngularSpeed Parse(string text, NumberStyles styles)
        {
            return QuantityParser.Parse<AngularSpeedUnit, AngularSpeed>(text, From, styles, CultureInfo.CurrentCulture);
        }
        ...
        public static bool TryParse(string text, out AngularSpeed result)
        {
            return QuantityParser.TryParse<AngularSpeedUnit, AngularSpeed>(text, From, NumberStyles.Float, CultureInfo.CurrentCulture, out result);
        }
        ...
        /// <param name="result">The parsed <see cref="AngularSpeed"/></param>
        /// <returns>True if an instance of <see cref="AngularSpeed"/> could be parsed from <paramref name="text"/></returns>
        public static bool TryParse(string text, IFormatProvider provider, out AngularSpeed result)
        {
            return QuantityParser.TryParse<AngularSpeedUnit, AngularSpeed>(text, From, NumberStyles.Float, provider, out result);
        }
        ...
        /// <returns>
        /// true if <paramref name="obj"/> represents the same <see cref="Gu.Units.AngularSpeed"/> as this instance; otherwise, false.
        /// </returns>
        public override bool Equals(object? obj)
        {
            return obj is AngularSpeed other && this.Equals(other);
        }
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(this.radiansPerSecond);
