namespace Gu.Units
{
    ...
    public partial struct AmountOfSubstance : IQuantity<AmountOfSubstanceUnit>, IComparable<AmountOfSubstance>, IEquatable<AmountOfSubstance>
    {
        ...
        /// </summary>
        /// <param name="s">The string representation of the <see cref="Gu.Units.AmountOfSubstance"/></param>
        /// <returns></returns>
		public static AmountOfSubstance Parse(string s)
        {
            return QuantityParser.Parse<AmountOfSubstanceUnit, AmountOfSubstance>(s, From, NumberStyles.Float, CultureInfo.CurrentCulture);
        }

        public static AmountOfSubstance Parse(string s, IFormatProvider provider)
        {
            return QuantityParser.Parse<AmountOfSubstanceUnit, AmountOfSubstance>(s, From, NumberStyles.Float, provider);
        }

        public static AmountOfSubstance Parse(string s, NumberStyles styles)
        {
            return QuantityParser.Parse<AmountOfSubstanceUnit, AmountOfSubstance>(s, From, styles, CultureInfo.CurrentCulture);
        }

        public static AmountOfSubstance Parse(string s, NumberStyles styles, IFormatProvider provider)
        {
            return QuantityParser.Parse<AmountOfSubstanceUnit, AmountOfSubstance>(s, From, styles, provider);
        }

        public static bool TryParse(string s, out AmountOfSubstance value)
        {
            return QuantityParser.TryParse<AmountOfSubstanceUnit, AmountOfSubstance>(s, From, NumberStyles.Float, CultureInfo.CurrentCulture, out value);
        }

        public static bool TryParse(string s, IFormatProvider provider, out AmountOfSubstance value)
        {
            return QuantityParser.TryParse<AmountOfSubstanceUnit, AmountOfSubstance>(s, From, NumberStyles.Float, provider, out value);
        }

        public static bool TryParse(string s, NumberStyles styles, out AmountOfSubstance value)
        {
            return QuantityParser.TryParse<AmountOfSubstanceUnit, AmountOfSubstance>(s, From, styles, CultureInfo.CurrentCulture, out value);
        }

        public static bool TryParse(string s, NumberStyles styles, IFormatProvider provider, out AmountOfSubstance value)
        {
            return QuantityParser.TryParse<AmountOfSubstanceUnit, AmountOfSubstance>(s, From, styles, provider, out value);
        }
