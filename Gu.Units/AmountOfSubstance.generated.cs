...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct AmountOfSubstance : IQuantity<AmountOfSubstanceUnit>, IComparable<AmountOfSubstance>, IEquatable<AmountOfSubstance>, IXmlSerializable
    {
        /// <summary>
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.AmountOfSubstance"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.AmountOfSubstance"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.AmountOfSubstance"/>.</param>
        ...
        {
            return obj is AmountOfSubstance other && this.Equals(other);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new AmountOfSubstance(XmlConvert.ToDouble(attribute), AmountOfSubstanceUnit.Moles);
