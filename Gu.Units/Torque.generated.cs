...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct Torque : IQuantity<TorqueUnit>, IComparable<Torque>, IEquatable<Torque>, IXmlSerializable
    {
        /// <summary>
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.Torque"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Torque"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Torque"/>.</param>
        ...
        /// <returns>
        /// true if <paramref name="obj"/> represents the same <see cref="Gu.Units.Torque"/> as this instance; otherwise, false.
        /// </returns>
        public override bool Equals(object? obj)
        {
            return obj is Torque other && this.Equals(other);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new Torque(XmlConvert.ToDouble(attribute), TorqueUnit.NewtonMetres);
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(this.newtonMetres);
