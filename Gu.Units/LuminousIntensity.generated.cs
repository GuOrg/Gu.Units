...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct LuminousIntensity : IQuantity<LuminousIntensityUnit>, IComparable<LuminousIntensity>, IEquatable<LuminousIntensity>, IXmlSerializable
    {
        /// <summary>
        /// Gets a value that is zero <see cref="Gu.Units.LuminousIntensityUnit.Candelas"/>
        /// </summary>
        public static readonly LuminousIntensity Zero = default(LuminousIntensity);
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gu.Units.LuminousIntensity"/> struct.
        /// </summary>
        ...
        /// <summary>
        /// Gets the quantity in <see cref="Gu.Units.LuminousIntensityUnit.Candelas"/>
        /// </summary>
        public double SiValue => this.candelas;

        /// <summary>
        /// Gets the <see cref="Gu.Units.LuminousIntensityUnit"/> for the <see cref="SiValue"/>
        /// </summary>
        ...
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.LuminousIntensity"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.LuminousIntensity"/>.</param>
        ...
        /// <returns>Multiplies <paramref name="left"/> with <see cref="Gu.Units.LuminousIntensity"/> and returns the result.</returns>
        ...
        /// <returns>Multiplies an <see cref="Gu.Units.LuminousIntensity"/> with <paramref name="right"/> and returns the result.</returns>
        ...
        /// <param name="left">The left instance of <see cref="Gu.Units.LuminousIntensity"/></param>
        /// <param name="right">The right instance of <seealso cref="double"/></param>
        /// <returns>Divides an instance of <see cref="Gu.Units.LuminousIntensity"/> by <paramref name="right"/> and returns the result.</returns>
        public static LuminousIntensity operator /(LuminousIntensity left, double right)
        {
            return new LuminousIntensity(left.candelas / right);
        }
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.LuminousIntensity"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.LuminousIntensity"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.LuminousIntensity"/>.</param>
        ...
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.LuminousIntensity"/> (the minuend).</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.LuminousIntensity"/> (the subtrahend).</param>
        public static LuminousIntensity operator -(LuminousIntensity left, LuminousIntensity right)
        {
            return new LuminousIntensity(left.candelas - right.candelas);
        }
        ...
        {
            var quantityFormat = FormatCache<LuminousIntensityUnit>.GetOrCreate(string.Empty, this.SiUnit);
        ...
        {
            return obj is LuminousIntensity other && this.Equals(other);
        }
