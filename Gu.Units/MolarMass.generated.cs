...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct MolarMass : IQuantity<MolarMassUnit>, IComparable<MolarMass>, IEquatable<MolarMass>, IXmlSerializable
    {
        /// <summary>
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.MolarMass"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.MolarMass"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.MolarMass"/>.</param>
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new MolarMass(XmlConvert.ToDouble(attribute), MolarMassUnit.KilogramsPerMole);
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(this.kilogramsPerMole);
