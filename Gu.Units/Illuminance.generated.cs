namespace Gu.Units
{
    ...
    public partial struct Illuminance : IQuantity<IlluminanceUnit>, IComparable<Illuminance>, IEquatable<Illuminance>
    {
        ...
        /// </summary>
        /// <param name="s">The string representation of the <see cref="Gu.Units.Illuminance"/></param>
        /// <returns></returns>
		public static Illuminance Parse(string s)
        {
            return QuantityParser.Parse<IlluminanceUnit, Illuminance>(s, From, NumberStyles.Float, CultureInfo.CurrentCulture);
        }

        public static Illuminance Parse(string s, IFormatProvider provider)
        {
            return QuantityParser.Parse<IlluminanceUnit, Illuminance>(s, From, NumberStyles.Float, provider);
        }

        public static Illuminance Parse(string s, NumberStyles styles)
        {
            return QuantityParser.Parse<IlluminanceUnit, Illuminance>(s, From, styles, CultureInfo.CurrentCulture);
        }

        public static Illuminance Parse(string s, NumberStyles styles, IFormatProvider provider)
        {
            return QuantityParser.Parse<IlluminanceUnit, Illuminance>(s, From, styles, provider);
        }

        public static bool TryParse(string s, out Illuminance value)
        {
            return QuantityParser.TryParse<IlluminanceUnit, Illuminance>(s, From, NumberStyles.Float, CultureInfo.CurrentCulture, out value);
        }

        public static bool TryParse(string s, IFormatProvider provider, out Illuminance value)
        {
            return QuantityParser.TryParse<IlluminanceUnit, Illuminance>(s, From, NumberStyles.Float, provider, out value);
        }

        public static bool TryParse(string s, NumberStyles styles, out Illuminance value)
        {
            return QuantityParser.TryParse<IlluminanceUnit, Illuminance>(s, From, styles, CultureInfo.CurrentCulture, out value);
        }

        public static bool TryParse(string s, NumberStyles styles, IFormatProvider provider, out Illuminance value)
        {
            return QuantityParser.TryParse<IlluminanceUnit, Illuminance>(s, From, styles, provider, out value);
        }
        ...
        /// <summary>
        /// Compares this instance to a specified <see cref="Gu.Units.Illuminance"/> object and returns an integer that indicates whether this <see cref="quantity"/> is smaller than, equal to, or greater than the <see cref="Gu.Units.Illuminance"/> object.
        /// </summary>
        /// <returns>
