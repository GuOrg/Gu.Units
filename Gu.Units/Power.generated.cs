...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct Power : IQuantity<PowerUnit>, IComparable<Power>, IEquatable<Power>, IXmlSerializable
    {
        /// <summary>
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.Power"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Power"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Power"/>.</param>
        ...
        {
            return obj is Power other && this.Equals(other);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new Power(XmlConvert.ToDouble(attribute), PowerUnit.Watts);
