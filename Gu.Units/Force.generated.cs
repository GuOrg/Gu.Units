...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct Force : IQuantity<ForceUnit>, IComparable<Force>, IEquatable<Force>, IXmlSerializable
    {
        /// <summary>
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.Force"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Force"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Force"/>.</param>
        ...
        {
            return obj is Force other && this.Equals(other);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new Force(XmlConvert.ToDouble(attribute), ForceUnit.Newtons);
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(this.newtons);
