namespace Gu.Units
{
    ...
    public partial struct MassFlow : IQuantity<MassFlowUnit>, IComparable<MassFlow>, IEquatable<MassFlow>
    {
        ...
        /// </summary>
        /// <param name="s">The string representation of the <see cref="Gu.Units.MassFlow"/></param>
        /// <returns></returns>
		public static MassFlow Parse(string s)
        {
            return QuantityParser.Parse<MassFlowUnit, MassFlow>(s, From, NumberStyles.Float, CultureInfo.CurrentCulture);
        }

        public static MassFlow Parse(string s, IFormatProvider provider)
        {
            return QuantityParser.Parse<MassFlowUnit, MassFlow>(s, From, NumberStyles.Float, provider);
        }

        public static MassFlow Parse(string s, NumberStyles styles)
        {
            return QuantityParser.Parse<MassFlowUnit, MassFlow>(s, From, styles, CultureInfo.CurrentCulture);
        }

        public static MassFlow Parse(string s, NumberStyles styles, IFormatProvider provider)
        {
            return QuantityParser.Parse<MassFlowUnit, MassFlow>(s, From, styles, provider);
        }

        public static bool TryParse(string s, out MassFlow value)
        {
            return QuantityParser.TryParse<MassFlowUnit, MassFlow>(s, From, NumberStyles.Float, CultureInfo.CurrentCulture, out value);
        }

        public static bool TryParse(string s, IFormatProvider provider, out MassFlow value)
        {
            return QuantityParser.TryParse<MassFlowUnit, MassFlow>(s, From, NumberStyles.Float, provider, out value);
        }

        public static bool TryParse(string s, NumberStyles styles, out MassFlow value)
        {
            return QuantityParser.TryParse<MassFlowUnit, MassFlow>(s, From, styles, CultureInfo.CurrentCulture, out value);
        }

        public static bool TryParse(string s, NumberStyles styles, IFormatProvider provider, out MassFlow value)
        {
            return QuantityParser.TryParse<MassFlowUnit, MassFlow>(s, From, styles, provider, out value);
        }
