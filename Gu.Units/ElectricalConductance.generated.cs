...
namespace Gu.Units
{
    ...
    public partial struct ElectricalConductance : IQuantity<ElectricalConductanceUnit>, IComparable<ElectricalConductance>, IEquatable<ElectricalConductance>, IXmlSerializable
    {
        ...
        /// </summary>
        public static readonly ElectricalConductance Zero = default(ElectricalConductance);
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gu.Units.ElectricalConductance"/> struct.
        /// </summary>
        ...
        /// <summary>
        /// Gets the quantity in <see cref="Gu.Units.ElectricalConductanceUnit.Siemens"/>
        /// </summary>
        public double SiValue => this.siemens;

        /// <summary>
        /// Gets the <see cref="Gu.Units.ElectricalConductanceUnit"/> for the <see cref="SiValue"/>
        /// </summary>
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.ElectricalConductance"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.ElectricalConductance"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.ElectricalConductance"/>.</param>
        ...
        {
            var quantityFormat = FormatCache<ElectricalConductanceUnit>.GetOrCreate(string.Empty, this.SiUnit);
        ...
        {
            return obj is ElectricalConductance other && this.Equals(other);
        }
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(this.siemens);
