...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct Resistance : IQuantity<ResistanceUnit>, IComparable<Resistance>, IEquatable<Resistance>, IXmlSerializable
    {
        /// <summary>
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.Resistance"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Resistance"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Resistance"/>.</param>
        ...
        {
            return obj is Resistance other && this.Equals(other);
        }
