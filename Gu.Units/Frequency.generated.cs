...
namespace Gu.Units
{
    ...
    public partial struct Frequency : IQuantity<FrequencyUnit>, IComparable<Frequency>, IEquatable<Frequency>, IXmlSerializable
    {
        ...
        /// </summary>
        public static readonly Frequency Zero = default(Frequency);
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gu.Units.Frequency"/> struct.
        /// </summary>
        ...
        /// <summary>
        /// Gets the quantity in <see cref="Gu.Units.FrequencyUnit.Hertz"/>
        /// </summary>
        public double SiValue => this.hertz;

        /// <summary>
        /// Gets the <see cref="Gu.Units.FrequencyUnit"/> for the <see cref="SiValue"/>
        /// </summary>
        ...
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Frequency"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Frequency"/>.</param>
        ...
        /// <returns>Multiplies <paramref name="left"/> with <see cref="Gu.Units.Frequency"/> and returns the result.</returns>
        ...
        /// <returns>Multiplies an <see cref="Gu.Units.Frequency"/> with <paramref name="right"/> and returns the result.</returns>
        ...
        /// <param name="left">The left instance of <see cref="Gu.Units.Frequency"/></param>
        /// <param name="right">The right instance of <seealso cref="double"/></param>
        /// <returns>Divides an instance of <see cref="Gu.Units.Frequency"/> by <paramref name="right"/> and returns the result.</returns>
        public static Frequency operator /(Frequency left, double right)
        {
            return new Frequency(left.hertz / right);
        }
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.Frequency"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Frequency"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Frequency"/>.</param>
        ...
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Frequency"/> (the minuend).</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Frequency"/> (the subtrahend).</param>
        public static Frequency operator -(Frequency left, Frequency right)
        {
            return new Frequency(left.hertz - right.hertz);
        }
        ...
        {
            var quantityFormat = FormatCache<FrequencyUnit>.GetOrCreate(string.Empty, this.SiUnit);
        ...
        {
            return obj is Frequency other && this.Equals(other);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new Frequency(XmlConvert.ToDouble(attribute), FrequencyUnit.Hertz);
