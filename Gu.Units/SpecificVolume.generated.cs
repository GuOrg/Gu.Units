...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct SpecificVolume : IQuantity<SpecificVolumeUnit>, IComparable<SpecificVolume>, IEquatable<SpecificVolume>, IXmlSerializable
    {
        /// <summary>
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.SpecificVolume"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.SpecificVolume"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.SpecificVolume"/>.</param>
        ...
        {
            return obj is SpecificVolume other && this.Equals(other);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new SpecificVolume(XmlConvert.ToDouble(attribute), SpecificVolumeUnit.CubicMetresPerKilogram);
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(this.cubicMetresPerKilogram);
