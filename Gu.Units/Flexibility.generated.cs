...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.Flexibility"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Flexibility"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Flexibility"/>.</param>
        ...
        {
            return obj is Flexibility other && this.Equals(other);
        }
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(this.metresPerNewton);
