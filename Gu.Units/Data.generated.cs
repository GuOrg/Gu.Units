...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.Data"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Data"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Data"/>.</param>
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new Data(XmlConvert.ToDouble(attribute), DataUnit.Bits);
