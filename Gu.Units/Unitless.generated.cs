...
namespace Gu.Units
{
    ...
    public partial struct Unitless : IQuantity<UnitlessUnit>, IComparable<Unitless>, IEquatable<Unitless>, IXmlSerializable
    {
        ...
        /// </summary>
        public static readonly Unitless Zero = default(Unitless);
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gu.Units.Unitless"/> struct.
        /// </summary>
        ...
        /// <summary>
        /// Gets the quantity in <see cref="Gu.Units.UnitlessUnit.Scalar"/>
        /// </summary>
        public double SiValue => this.scalar;

        /// <summary>
        /// Gets the <see cref="Gu.Units.UnitlessUnit"/> for the <see cref="SiValue"/>
        /// </summary>
        ...
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Unitless"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Unitless"/>.</param>
        ...
        /// <returns>Multiplies <paramref name="left"/> with <see cref="Gu.Units.Unitless"/> and returns the result.</returns>
        ...
        /// <returns>Multiplies an <see cref="Gu.Units.Unitless"/> with <paramref name="right"/> and returns the result.</returns>
        ...
        /// <param name="left">The left instance of <see cref="Gu.Units.Unitless"/></param>
        /// <param name="right">The right instance of <seealso cref="double"/></param>
        /// <returns>Divides an instance of <see cref="Gu.Units.Unitless"/> by <paramref name="right"/> and returns the result.</returns>
        public static Unitless operator /(Unitless left, double right)
        {
            return new Unitless(left.scalar / right);
        }
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.Unitless"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Unitless"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Unitless"/>.</param>
        ...
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Unitless"/> (the minuend).</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Unitless"/> (the subtrahend).</param>
        public static Unitless operator -(Unitless left, Unitless right)
        {
            return new Unitless(left.scalar - right.scalar);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new Unitless(XmlConvert.ToDouble(attribute), UnitlessUnit.Scalar);
