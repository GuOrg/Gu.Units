...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct MolarHeatCapacity : IQuantity<MolarHeatCapacityUnit>, IComparable<MolarHeatCapacity>, IEquatable<MolarHeatCapacity>, IXmlSerializable
    {
        /// <summary>
        /// Gets a value that is zero <see cref="Gu.Units.MolarHeatCapacityUnit.JoulesPerKelvinMole"/>
        /// </summary>
        public static readonly MolarHeatCapacity Zero = default(MolarHeatCapacity);
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gu.Units.MolarHeatCapacity"/> struct.
        /// </summary>
        ...
        /// <summary>
        /// Gets the quantity in <see cref="Gu.Units.MolarHeatCapacityUnit.JoulesPerKelvinMole"/>
        /// </summary>
        public double SiValue => this.joulesPerKelvinMole;

        /// <summary>
        /// Gets the <see cref="Gu.Units.MolarHeatCapacityUnit"/> for the <see cref="SiValue"/>
        /// </summary>
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.MolarHeatCapacity"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.MolarHeatCapacity"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.MolarHeatCapacity"/>.</param>
        ...
        {
            var quantityFormat = FormatCache<MolarHeatCapacityUnit>.GetOrCreate(string.Empty, this.SiUnit);
        ...
        {
            return obj is MolarHeatCapacity other && this.Equals(other);
        }
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(this.joulesPerKelvinMole);
