namespace Gu.Units
{
    ...
    public class MagneticFluxUnitTypeConverter : TypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            {
                text = text.Trim();
                return MagneticFluxUnit.Parse(text);
            }
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            if (destinationType == typeof(InstanceDescriptor) && value is MagneticFluxUnit)
            {
                MethodInfo method = typeof(MagneticFluxUnit).GetMethod(nameof(MagneticFluxUnit.Parse), new Type[] { typeof(string) });
                if (method != null)
                {
                    var args = new object[] { ((MagneticFluxUnit)value).Symbol };
