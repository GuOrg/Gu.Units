namespace Gu.Units
{
    ...
    public partial struct Mass : IQuantity<MassUnit>, IComparable<Mass>, IEquatable<Mass>
    {
        ...
        /// </summary>
        /// <param name="s">The string representation of the <see cref="Gu.Units.Mass"/></param>
        /// <returns></returns>
		public static Mass Parse(string s)
        {
            return QuantityParser.Parse<MassUnit, Mass>(s, From, NumberStyles.Float, CultureInfo.CurrentCulture);
        }

        public static Mass Parse(string s, IFormatProvider provider)
        {
            return QuantityParser.Parse<MassUnit, Mass>(s, From, NumberStyles.Float, provider);
        }

        public static Mass Parse(string s, NumberStyles styles)
        {
            return QuantityParser.Parse<MassUnit, Mass>(s, From, styles, CultureInfo.CurrentCulture);
        }

        public static Mass Parse(string s, NumberStyles styles, IFormatProvider provider)
        {
            return QuantityParser.Parse<MassUnit, Mass>(s, From, styles, provider);
        }

        public static bool TryParse(string s, out Mass value)
        {
            return QuantityParser.TryParse<MassUnit, Mass>(s, From, NumberStyles.Float, CultureInfo.CurrentCulture, out value);
        }

        public static bool TryParse(string s, IFormatProvider provider, out Mass value)
        {
            return QuantityParser.TryParse<MassUnit, Mass>(s, From, NumberStyles.Float, provider, out value);
        }

        public static bool TryParse(string s, NumberStyles styles, out Mass value)
        {
            return QuantityParser.TryParse<MassUnit, Mass>(s, From, styles, CultureInfo.CurrentCulture, out value);
        }

        public static bool TryParse(string s, NumberStyles styles, IFormatProvider provider, out Mass value)
        {
            return QuantityParser.TryParse<MassUnit, Mass>(s, From, styles, provider, out value);
        }
