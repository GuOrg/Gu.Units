...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Time"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Time"/>.</param>
        ...
        /// <returns>Multiplies <paramref name="left"/> with <see cref="Gu.Units.Time"/> and returns the result.</returns>
        ...
        /// <returns>Multiplies an <see cref="Gu.Units.Time"/> with <paramref name="right"/> and returns the result.</returns>
        ...
        /// <param name="left">The left instance of <see cref="Gu.Units.Time"/></param>
        /// <param name="right">The right instance of <seealso cref="double"/></param>
        /// <returns>Divides an instance of <see cref="Gu.Units.Time"/> by <paramref name="right"/> and returns the result.</returns>
        public static Time operator /(Time left, double right)
        {
            return new Time(left.seconds / right);
        }
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.Time"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Time"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Time"/>.</param>
        ...
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.Time"/> (the minuend).</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.Time"/> (the subtrahend).</param>
        public static Time operator -(Time left, Time right)
        {
            return new Time(left.seconds - right.seconds);
        }
        ...
        {
            return obj is Time other && this.Equals(other);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new Time(XmlConvert.ToDouble(attribute), TimeUnit.Seconds);
