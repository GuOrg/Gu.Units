...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="Gu.Units.MagneticFlux"/> whose quantity is the sum of the quantities of <paramref name="left"/> and <paramref name="right"/>.
        /// </returns>
        /// <param name="left">The left instance of <see cref="Gu.Units.MagneticFlux"/>.</param>
        /// <param name="right">The right instance of <see cref="Gu.Units.MagneticFlux"/>.</param>
        ...
        {
            return obj is MagneticFlux other && this.Equals(other);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new MagneticFlux(XmlConvert.ToDouble(attribute), MagneticFluxUnit.Webers);
