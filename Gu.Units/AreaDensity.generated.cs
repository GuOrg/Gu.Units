...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct AreaDensity : IQuantity<AreaDensityUnit>, IComparable<AreaDensity>, IEquatable<AreaDensity>, IXmlSerializable
    {
        /// <summary>
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        /// <returns>
        /// true if <paramref name="obj"/> represents the same <see cref="Gu.Units.AreaDensity"/> as this instance; otherwise, false.
        /// </returns>
        public override bool Equals(object? obj)
        {
            return obj is AreaDensity other && this.Equals(other);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new AreaDensity(XmlConvert.ToDouble(attribute), AreaDensityUnit.KilogramsPerSquareMetre);
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(this.kilogramsPerSquareMetre);
